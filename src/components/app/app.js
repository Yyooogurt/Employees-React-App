...
class App extends Component {
    constructor(props) {
        ...
        this.state = {
            data: [
                ...
                { name: "Alex W.", salary: 4000, increase: true, rise: false, id: 2 },
                { name: "Dave R.", salary: 5000, increase: false, rise: false, id: 3 },
            ],
            term: "",
            filter: "all", // all, increase, moreThen1000
        };
        this.maxId = 4;
    }
    ...
    onUpdateSearch = (term) => {
        ...
        this.setState({ term }); // Short version
    };
